...
[`a2ui/design.md`](../a2ui/design.md) owns the agent-facing A2UI component contract and links
...
Cross-reference with [`openspec/changes/`](../../changes/) before structural work.
...
(see [`testing/design.md`](../testing/design.md)) plus direct screenshots.
...
[`a2ui/design.md`](../a2ui/design.md) — renderer, `render_ui` description in
