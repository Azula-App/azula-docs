...
brand live in [`design-system/design.md`](../design-system/design.md), which is normative for
...
- **Tokens:** `azula-app/a2ui/.../A2uiTokens.kt` — the semantic tokens the renderer
  ...
  [`design-system/design.md`](../design-system/design.md). Brand colors are shared with
  ...
  Phase 4 of the chat-consolidation plan (`azula-docs/openspec/specs/architecture-di/design.md`
...
See [`design-system/design.md`](../design-system/design.md) — §3 color, §4 typography,
...
[`design-system/design.md`](../design-system/design.md) first — it is normative — then update
